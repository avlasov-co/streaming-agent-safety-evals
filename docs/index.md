...
Start here if you are reviewing the repository quickly.

## Core overview

- [README](../README.md)
- [Reviewer quickstart](reviewer_quickstart.md)
- [Fellowship application summary](fellowship_application_summary.md)

## Research framing

- [Mini-paper](paper.md)
- [Safety relevance](safety_relevance.md)
...
- [Proprietary boundary](proprietary_boundary.md)
